<template>
  <div
    role="tablist"
    :class="[
      'ios-segment bg-base-300/50 inline-flex rounded-sm p-1 align-middle',
      block && 'flex w-full',
    ]"
  >
    <div
    ...
    >
      <div
        class="ios-segment-indicator bg-primary ring-base-content/5 pointer-events-none absolute top-0 bottom-0 left-0 rounded-sm shadow-sm ring-1"
      ...
      <button
        ...
        type="button"
        :class="[
          'ios-segment-item relative z-1 flex items-center justify-center gap-1 rounded-sm px-3 py-1 text-sm whitespace-nowrap transition-colors duration-150',
