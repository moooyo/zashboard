...
const zhTW: LANG_MESSAGE = {
  ...
  gpnLogsTab: '日誌',
  gpnLogSearch: '搜尋訊息',
  gpnLogAllExtensions: '全部擴充',
  gpnLogAllLevels: '全部等級',
  gpnLogWindow: '最近 500 筆保留記錄',
  gpnLogEmpty: '還沒有擴充輸出被保留。',
  gpnLogLevel: '等級',
  gpnLogExtension: '擴充',
  gpnLogAction: '動作',
  gpnLogMessage: '訊息',
  gpnCatalogRefresh: '重新整理目錄',
  gpnCatalogSourceId: '市集 ID',
  gpnCatalogSourceUrl: '市集索引 URL',
  gpnCatalogSourceName: '名稱（選填）',
  gpnCatalogSourceAdd: '新增市集',
  gpnCatalogSourceRemove: '移除',
  gpnCatalogSourceEnable: '啟用',
  gpnCatalogSourceDisable: '停用',
  gpnCatalogSourceDuplicateId: '已存在 ID 為 {id} 的來源。',
  gpnCatalogSourceDuplicateUrl: '該 URL 已設定：{url}',
  gpnInstalled: '已安裝',
  gpnNetworkGrant: '網路授權',
  gpnBotSettings: 'Telegram 機器人',
  gpnBotAbsent: '此閘道未安裝 Telegram 機器人。',
  gpnBotEnabled: '啟用機器人',
  gpnBotState: '連線狀態',
  gpnBotToken: '機器人 token',
  gpnBotTokenStored: '已儲存 —— 留空表示不修改',
  gpnBotTokenUnset: '未設定',
  gpnBotTokenClear: '清除',
  gpnBotAdmins: '管理員 Telegram id',
  gpnBotAlerts: '警示',
  gpnBotSave: '儲存機器人設定',
  gpnBotReadOnlyNote:
  ...
  gpnDnsPolicy: '解析策略',
  gpnDnsFallback: '未命中的名稱',
  gpnDnsRules: '解析規則',
  gpnDnsSubscriptions: '規則訂閱',
  gpnSubNone: '還沒有設定訂閱。',
  gpnSubAdd: '新增訂閱',
  ...
  gpnDnsTrust: '可信組',
  gpnDnsEcs: '用戶端子網',
  gpnDnsResolve: '解析一個名稱',
  gpnDnsFlush: '快取',
  gpnDnsUpstreams: '上游與閘道',
  gpnDnsDiagnose: '診斷',
  gpnFallback: '未命中的名稱',
  gpnFallbackAuto: '自動',
  gpnFallbackDirect: '直連',
  gpnFallbackGateway: '走閘道',
  gpnFallbackAutoHint: '國內組與可信組仲裁,境外位址改寫為閘道位址。',
  gpnFallbackDirectHint: '同樣的仲裁,但回傳真實位址。',
  gpnFallbackGatewayHint: '不問上游,直接回傳閘道位址。',
  gpnIntentBlock: '攔截',
  gpnIntentDirect: '直連',
  gpnIntentProxy: '走閘道',
  gpnKindDomain: '精確名稱',
  ...
  gpnInterval: '秒',
  gpnAddRule: '新增規則',
  gpnSubEntries: '{entries} 筆',
  gpnSubError: '上次抓取失敗,仍在使用 {entries} 筆',
  gpnSubNotFetched: '尚未抓取',
  gpnGateway: '閘道位址',
  gpnGatewayHint: '被引導的名稱解析到的 IPv4 位址。留空則境外答案原樣回傳,而不是指向這裡。',
  gpnChinaGroup: '國內組',
  gpnTrustGroup: '可信組',
  gpnUpstreamGrammar:
  ...
  gpnVerdict: '判定',
  gpnDecidedBy: '由誰決定',
  gpnDecidedByRule: '規則 {kind} {value}',
  gpnDecidedByFallback: '{fallback} 後備',
  gpnDecidedByExtension: '擴充 {name} 擷取 {pattern}',
  gpnDecidedByExtensionInert: '擴充 {name} 宣告了它,但 MITM 總開關是關的',
  gpnClientAnswer: '給用戶端的答案',
  gpnOriginAnswer: '給閘道的答案',
  gpnUpstreamAdopted: '採納的上游',
  gpnCacheHit: '命中快取',
  gpnRcode: '回應碼',
  gpnQueriesTotal: '查詢總數',
  gpnDnsCard: '5gpn DNS',
  gpnSetupGuide: '設定精靈',
  gpnGuideUnknownHost:
    '当前面板在 {host},不是 console.<base>,无法据此推出 DoT 名字。请从安装器输出里读取 dot.<base>。',
  gpnGuideDot: 'DoT 地址',
  gpnGuideDotHint: '唯一的客户端 DNS 入口。没有明文 :53,也没有公共 DoH。',
  gpnGuideCopy: '复制',
  gpnGuideCopied: '已复制',
  gpnGuideAndroid: 'Android',
  gpnGuideAndroid1: '打开 设置 → 网络 → 私人 DNS。',
  gpnGuideAndroid2: '选择「指定主机名」并填入',
  gpnGuideAndroid3: '保存。首次启用前,这个名字必须能被你原有的解析器解析。',
  gpnGuideAndroidCa: '现代 Android 应用默认不信任用户安装的 CA,因此本项目不提供 Android 拦截流程。',
  gpnGuideIos: 'iOS',
  gpnGuideIos1: '扫码,或直接下载描述文件。',
  gpnGuideIos2: '系统设置里会出现「已下载描述文件」,打开并安装。',
  gpnGuideIos3: '在 设置 → 通用 → VPN 与设备管理 里确认已生效。',
  gpnGuideDownloadProfile: '下载 DoT 描述文件',
  gpnGuideCa: '拦截 CA(可选)',
  gpnGuideCaWhat: '只有在启用了解密流量的扩展时才需要。不装它,那些主机会连不上,而不是被拦截。',
  gpnGuideDownloadCa: '下载 CA 描述文件',
  gpnGuideCaTrust: 'iOS 还需要手动为该证书启用完全信任。',
  gpnGuideVerify: '验证',
  gpnGuideDotPort: 'DoT 监听',
  gpnGuideVerifyHint: '被引导的名字解析到网关地址,其余名字保留真实地址。',
  gpnQps: '每秒查詢',
  ...
  gpnCnRanges: 'CN 網段',
  gpnLoaded: '已載入',
  gpnLoadedLists: '訂閱 {lists} 份 · {entries} 條',
  gpnLoadedListsFailed: '{count} 份抓取失敗',
  gpnNoSamples: '無樣本',
  gpnQueryLogFilter: '按名稱或用戶端篩選',
  gpnQueryLogWindow: '最近五分鐘,只在記憶體裡。',
  gpnLogTime: '時間',
  gpnLogName: '名稱',
  gpnLogType: '類型',
  gpnLogAnswer: '答案',
  ...
  gpnUnsaved: '有未儲存的變更',
  gpnSaved: '已儲存',
  gpnConflict: '在你編輯期間有人改過它。最新狀態已經取回 —— 請重新確認後再試。',
  ...
  gpnCheckUpdate: '檢查更新',
  gpnUninstall: '解除安裝',
  gpnUninstallConfirm: '解除安裝 {name}?',
  gpnCancel: '取消',
  gpnActions: '腳本動作',
  gpnStorage: '持久化儲存',
  gpnRoutingRules: '路由規則',
  gpnDigest: '快照摘要',
  gpnUpdateFrom: '已安裝:{from}',
  gpnEgressGroup: '出口',
  gpnCaptureDns: '來源站解析組',
  gpnNoBinding: '未綁定',
