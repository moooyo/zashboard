...
const zhTW: LANG_MESSAGE = {
  ...
  fivegpnNotRequired: '不需要',
  fivegpnUpdateChanges: '本次更新的變更',
  fivegpnExactRoutingRules: '完整路由規則',
  fivegpnUpdateNeedsEgress: '請先在已安裝擴充上綁定出口群組，再套用此更新。',
  ...
  fivegpnEnableNeedsEgress: '此擴充要求出口群組，請先完成綁定。',
  ...
  fivegpnLifecycleDescription_egress_unavailable: '所需出口群組不可用，因此擴充尚未運作。',
  ...
  fivegpnDiffSettingsChanged: '參數類型發生變化：{settings}',
