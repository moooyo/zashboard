...
const ru: LANG_MESSAGE = {
  ...
  fivegpnCatalogFetchedAt: 'Загружено {time}',
  ...
  fivegpnMarketplaceHint:
    'Записи официального индекса расширений 5GPN — это только метаданные обнаружения. Каждая установка или обновление загружается и проверяется перед применением.',
  ...
  fivegpnMarketplaceNoResults: 'Нет записей Marketplace для текущего поиска.',
