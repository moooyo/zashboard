...
const ru: LANG_MESSAGE = {
  ...
  rememberControllerSecretHint:
    'Сохранить после закрытия всех вкладок. Иначе секрет хранится только в сеансе.',
  submit: 'Отправить',
  cancel: 'Отмена',
  delete: 'Удалить',
  download: 'Загружено',
  ...
  settingsDescriptionFiveGPNDns: 'Политика разрешения, апстримы и шлюз, диагностика DNS',
  settingsDescriptionFiveGPNInterception:
    'Переключатель перехвата, границы протоколов, расширения и хосты',
  settingsDescriptionFiveGPNBot: 'Доступ Telegram-бота, администраторы и оповещения',
  ...
  fivegpnGatewayHint:
    'Направленные имена разрешаются в этот IPv4-адрес, которым управляет установка. Чтобы изменить его, используйте поддерживаемый способ настройки для этого варианта развертывания.',
  ...
  fivegpnReviewContractChanged:
    'Шлюз использует другой контракт проверки. Перезагрузите Console перед повторной проверкой; действие не было разрешено.',
  ...
  fivegpnDnsDraftHint: 'Изменения остаются локальными до сохранения полного документа DNS.',
  ...
  fivegpnActionReviewSummary: 'Сводка проверки действий',
  fivegpnActionReviewDetails: 'Подробности проверки',
  fivegpnActionPhaseRequest: 'запрос',
  fivegpnActionPhaseResponse: 'ответ',
  fivegpnActionKindScript: 'сценарий',
  fivegpnActionKindJq: 'преобразование jq',
  fivegpnActionKindReject: 'отклонение',
  fivegpnActionKindMock: 'поддельный ответ',
  fivegpnActionKindHeaders: 'изменение заголовков',
  fivegpnActionKindRewrite: 'перезапись URL',
  fivegpnActionKindReplaceBody: 'замена тела',
  fivegpnActionGateAlways: 'всегда',
  fivegpnActionLimits: 'Ограничения выполнения',
  fivegpnActionTimeout: 'тайм-аут={value} мс',
  fivegpnActionBodyLimit: 'тело≤{value}',
  fivegpnActionBodyMode: 'режим тела={value}',
  fivegpnActionSource: 'Источник и точка входа',
  fivegpnActionCodeEvidence: 'Размер и дайджест кода',
  fivegpnActionReviewDigest: 'Дайджест проверки действия',
  fivegpnActionScriptSummary: 'Запускает проверенный сценарий через контракт входа {entry}.',
  fivegpnActionJqSummary: 'Запускает проверенную программу jq без отображения исходного текста.',
  fivegpnActionRejectSummary: 'Отклоняет совпавший обмен без запуска кода.',
  fivegpnActionMockHeaders: 'Заголовки ответа',
  fivegpnActionHeadersSet: 'Установить заголовки',
  fivegpnActionHeadersRemove: 'Удалить заголовки',
  fivegpnActionValueMap: 'Сопоставления значений настроек',
  fivegpnActionRewriteInPlace: 'статус=перезапись без перенаправления',
  fivegpnPublisherEgressMetadata:
    'Издатель отмечает выбор выхода как требующий проверки. Текущая привязка оператора: {group}.',
  ...
  fivegpnDiffActionAdded: 'Добавлено действие: {id} ({kind}).',
  fivegpnDiffActionRemoved: 'Удалено действие: {id} ({kind}).',
  fivegpnDiffActionChanged: 'Изменено действие: {id} ({kind}).',
  fivegpnDiffActionsReordered: 'Изменился порядок выполнения действий.',
