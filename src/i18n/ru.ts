...
const ru: LANG_MESSAGE = {
  ...
  fivegpnHttp2: 'HTTP/2',
  fivegpnHttp3: 'HTTP/3',
  fivegpnHttp3Unavailable: 'Недоступно · UDP/443 заблокирован',
  fivegpnHttp3Blocked:
    'Перехват поддерживает только HTTP/1.1 и опциональный HTTP/2. Клиенты только с HTTP/3 завершаются с ошибкой; клиенты с откатом протокола могут повторить попытку по TCP.',
