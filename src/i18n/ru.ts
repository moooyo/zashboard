...
const ru: LANG_MESSAGE = {
  ...
  gpnHttp2: 'HTTP/2',
  gpnHttp3: 'HTTP/3',
  gpnHttp3Unavailable: 'Недоступно · UDP/443 заблокирован',
  gpnHttp3Blocked:
  ...
  gpnCatalog: 'Магазин расширений',
  gpnInstalledTab: 'Установленные',
  gpnImportTab: 'Установка по URL',
  gpnLogsTab: 'Журнал',
  gpnLogSearch: 'Поиск по сообщениям',
  gpnLogAllExtensions: 'Все расширения',
  gpnLogAllLevels: 'Все уровни',
  gpnLogWindow: 'Последние 500 сохранённых событий',
  gpnLogEmpty: 'Вывод расширений пока не сохранён.',
  gpnLogLevel: 'Уровень',
  gpnLogExtension: 'Расширение',
  gpnLogAction: 'Действие',
  gpnLogMessage: 'Сообщение',
  gpnCatalogRefresh: 'Обновить каталог',
  gpnCatalogSourceId: 'ID магазина',
  gpnCatalogSourceUrl: 'URL индекса магазина',
  gpnCatalogSourceName: 'Название (необязательно)',
  gpnCatalogSourceAdd: 'Добавить магазин',
  gpnCatalogSourceRemove: 'Удалить',
  gpnCatalogSourceEnable: 'Включить',
  gpnCatalogSourceDisable: 'Отключить',
  gpnCatalogSourceDuplicateId: 'Источник с ID {id} уже существует.',
  gpnCatalogSourceDuplicateUrl: 'Этот URL уже настроен: {url}',
  gpnInstalled: 'Установлено',
  gpnNetworkGrant: 'Сетевой доступ',
  gpnBotSettings: 'Telegram-бот',
  gpnBotAbsent: 'На этом шлюзе Telegram-бот не установлен.',
  gpnBotEnabled: 'Бот включён',
  gpnBotState: 'Соединение',
  gpnBotToken: 'Токен бота',
  gpnBotTokenStored: 'сохранён — оставьте пустым, чтобы не менять',
  gpnBotTokenUnset: 'не задан',
  gpnBotTokenClear: 'Очистить',
  gpnBotAdmins: 'Telegram id администраторов',
  gpnBotAlerts: 'Оповещения',
  gpnBotSave: 'Сохранить настройки бота',
  gpnBotReadOnlyNote:
  ...
  gpnTabPolicy: 'Политика',
  gpnTabUpstreams: 'Апстримы',
  gpnTabDiagnose: 'Диагностика',
  gpnTabQueryLog: 'Журнал запросов',
  gpnDnsSettings: 'DNS',
  settingsMenuGpnDns: 'DNS',
  gpnDnsPolicy: 'Политика разрешения',
  gpnDnsFallback: 'Несовпавшие имена',
  gpnDnsRules: 'Правила разрешения',
  ...
  gpnDnsChina: 'Китайская группа',
  gpnDnsTrust: 'Доверенная группа',
  gpnDnsEcs: 'Подсеть клиента',
  gpnDnsResolve: 'Разрешить имя',
  gpnDnsFlush: 'Кэш',
  gpnDnsUpstreams: 'Апстримы и шлюз',
  gpnDnsDiagnose: 'Диагностика',
  gpnFallback: 'Имена без совпадений',
  gpnFallbackAuto: 'Авто',
  gpnFallbackDirect: 'Напрямую',
  gpnFallbackGateway: 'Через шлюз',
  gpnFallbackAutoHint:
    'Арбитраж между китайской и доверенной группой; зарубежные адреса заменяются адресом шлюза.',
  gpnFallbackDirectHint: 'Тот же арбитраж, но возвращаются реальные адреса.',
  gpnFallbackGatewayHint: 'Отвечать адресом шлюза, не обращаясь к апстриму.',
  gpnIntentBlock: 'Блокировать',
  gpnIntentDirect: 'Напрямую',
  gpnIntentProxy: 'Через шлюз',
  gpnKindDomain: 'Точное имя',
  gpnKindSuffix: 'Имя и поддомены',
  gpnKindKeyword: 'Содержит',
  gpnRuleValue: 'example.com',
  gpnInterval: 'Секунды',
  gpnAddRule: 'Добавить правило',
  gpnSubEntries: 'имён: {entries}',
  gpnSubError: 'последняя загрузка не удалась, используется имён: {entries}',
  gpnSubNotFetched: 'ещё не загружено',
  gpnGateway: 'Адрес шлюза',
  gpnGatewayHint:
    'IPv4-адрес, в который разрешается направленное имя. Если оставить пустым, зарубежные ответы возвращаются как есть.',
  gpnChinaGroup: 'Китайская группа',
  gpnTrustGroup: 'Доверенная группа',
  gpnUpstreamGrammar:
  ...
  gpnEcs: 'Подсеть клиента (китайская группа)',
  gpnEcsHint:
  ...
  gpnResolveTest: 'Разрешить имя',
  gpnResolveRun: 'Разрешить',
  gpnFlushCache: 'Очистить кэш',
  gpnVerdict: 'Вердикт',
  gpnDecidedBy: 'Решено',
  gpnDecidedByRule: 'правилом {kind} {value}',
  gpnDecidedByFallback: 'запасным вариантом {fallback}',
  gpnDecidedByExtension: 'расширением {name}, перехватывающим {pattern}',
  gpnDecidedByExtensionInert:
    'расширение {name} объявило его, но главный переключатель MITM выключен',
  gpnClientAnswer: 'Ответ клиенту',
  gpnOriginAnswer: 'Ответ шлюзу',
  gpnUpstreamAdopted: 'Апстрим',
  gpnCacheHit: 'из кэша',
  gpnRcode: 'Код ответа',
  gpnQueriesTotal: 'Запросов',
  gpnDnsCard: '5gpn DNS',
  gpnSetupGuide: 'Мастер настройки',
  gpnGuideUnknownHost:
  ...
  gpnCnRanges: 'диапазонов CN',
  gpnLoaded: 'Загружено',
  gpnLoadedLists: 'подписок: {lists} · имён: {entries}',
  gpnLoadedListsFailed: 'не загрузилось: {count}',
  gpnNoSamples: 'нет измерений',
  gpnQueryLogFilter: 'Фильтр по имени или клиенту',
  gpnQueryLogWindow: 'Последние пять минут, только в памяти.',
  gpnLogTime: 'Время',
  gpnLogName: 'Имя',
  gpnLogType: 'Тип',
  gpnLogAnswer: 'Ответ',
  gpnLogDuration: 'Заняло',
  gpnSave: 'Сохранить',
  gpnRevert: 'Отменить',
  gpnUnsaved: 'Есть несохранённые изменения',
  gpnSaved: 'Сохранено',
  gpnConflict:
  ...
  gpnUninstall: 'Удалить',
  gpnUninstallConfirm: 'Удалить {name}?',
  gpnCancel: 'Отмена',
  gpnActions: 'Действия сценариев',
  gpnStorage: 'Постоянное хранилище',
  gpnRoutingRules: 'Правила маршрутизации',
  gpnDigest: 'Дайджест снимка',
  gpnUpdateFrom: 'установлено: {from}',
  gpnEgressGroup: 'Выход',
  gpnCaptureDns: 'Резолвер источника',
  gpnNoBinding: 'нет',
