...
const zh: LANG_MESSAGE = {
  ...
  fivegpnUpdateNeedsEgress: '请先在已安装扩展上绑定出口组，再应用此更新。',
  ...
  fivegpnEnableNeedsEgress: '此扩展要求出口组，请先完成绑定。',
  ...
  fivegpnLifecycleDescription_egress_unavailable: '所需出口组不可用，因此扩展尚未运行。',
