...
const zh: LANG_MESSAGE = {
  ...
  gpnLogsTab: '日志',
  gpnLogSearch: '搜索消息',
  gpnLogAllExtensions: '全部扩展',
  gpnLogAllLevels: '全部级别',
  gpnLogWindow: '最近 500 条保留记录',
  gpnLogEmpty: '还没有扩展输出被保留。',
  gpnLogLevel: '级别',
  gpnLogExtension: '扩展',
  gpnLogAction: '动作',
  gpnLogMessage: '消息',
  gpnCatalogRefresh: '刷新市场',
  gpnCatalogSourceId: '市场 ID',
  gpnCatalogSourceUrl: '市场索引 URL',
  gpnCatalogSourceName: '名称（可选）',
  gpnCatalogSourceAdd: '添加市场',
  gpnCatalogSourceRemove: '移除',
  gpnCatalogSourceEnable: '启用',
  gpnCatalogSourceDisable: '停用',
  gpnCatalogSourceDuplicateId: '已存在 ID 为 {id} 的市场。',
  ...
  gpnCnRanges: 'CN 段',
  gpnLoaded: '已加载',
  gpnLoadedLists: '订阅 {lists} 份 · {entries} 条',
  gpnLoadedListsFailed: '{count} 份抓取失败',
  gpnNoSamples: '无样本',
