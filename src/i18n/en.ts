const en = {
  ...
  settingsDescriptionFiveGPNDns: 'Resolution policy, upstreams and gateway, and DNS diagnostics',
  settingsDescriptionFiveGPNInterception:
    'Interception switch, protocol boundaries, extensions, and captured hosts',
  settingsDescriptionFiveGPNBot: 'Telegram bot access, administrators, and alerts',
