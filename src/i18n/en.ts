const en = {
  ...
  gpnCatalog: 'Extension catalog',
  gpnCatalogRefresh: 'Refresh catalog',
  gpnCatalogSourceId: 'Source ID',
  gpnCatalogSourceUrl: 'Index URL',
  gpnCatalogSourceName: 'Label (optional)',
  gpnCatalogSourceAdd: 'Add source',
  gpnCatalogSourceRemove: 'Remove',
  gpnCatalogSourceEnable: 'Enable',
  gpnCatalogSourceDisable: 'Disable',
  gpnCatalogSourceDuplicateId: 'A source with the ID {id} already exists.',
