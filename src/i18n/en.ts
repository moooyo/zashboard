const en = {
  ...
  fivegpnCatalogFetchedAt: 'Fetched {time}',
  ...
  fivegpnMarketplaceHint:
    'Entries from the official 5GPN extension index are discovery metadata. Every install or update is fetched and reviewed before it can be applied.',
  ...
  fivegpnMarketplaceNoResults: 'No Marketplace entries match the current search.',
