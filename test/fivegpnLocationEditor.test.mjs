...
test('the interactive review mock negotiates interception v8 and serves location search', () => {
  assert.match(reviewMock, /'5gpn-interception': \{ version: 8, owner: 'mihomo' \}/u)
  assert.match(
    reviewMock,
